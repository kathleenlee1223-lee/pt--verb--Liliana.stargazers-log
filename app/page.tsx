...
const labels: Record<string, string> = {
  indicative: "陈述式", subjunctive: "虚拟式", imperative: "命令式", infinitive: "不定式",
  present: "一般现在时", simplePast: "一般过去时（简单）", compoundPast: "一般过去时（复合）", imperfect: "过去未完成时", future: "将来时", affirmative: "肯定命令式", negative: "否定命令式", personal: "人称不定式", impersonal: "非人称不定式",
};
const tenseOrder: Record<string, string[]> = { indicative: ["present", "simplePast", "compoundPast", "imperfect", "future"], subjunctive: ["present", "simplePast", "compoundPast", "imperfect", "future"], imperative: ["affirmative", "negative"], infinitive: ["personal", "impersonal"] };
...
function regular(word: string): Verb | null {
  ...
  return { infinitive: word, meaning: "规则动词", category: `规则 -${type}`, note: "规则动词会自动生成三大语气的常用时态。", forms: {
    ...
    "infinitive-personal": [word, `${word}s`, word, `${word}mos`, `${word}des`, `${word}em`], "infinitive-impersonal": [word],
  }};
}
...
const irregular: Verb[] = [
  { infinitive: "ser", meaning: "是；成为", category: "不规则动词", note: "完整展示 ser 的常用变位。", forms: {
    ...
    "imperative-affirmative":["—","sê","seja","sejamos","sede","sejam"], "imperative-negative":["—","não sejas","não seja","não sejamos","não sejais","não sejam"], "infinitive-personal":["ser","seres","ser","sermos","serdes","serem"], "infinitive-impersonal":["ser"]
  }},
  { infinitive: "estar", meaning: "在；处于", category: "不规则动词", note: "完整展示 estar 的常用变位。", forms: {
    ...
    "imperative-affirmative":["—","está","esteja","estejamos","estai","estejam"], "imperative-negative":["—","não estejas","não esteja","não estejamos","não estejais","não estejam"], "infinitive-personal":["estar","estares","estar","estarmos","estardes","estarem"], "infinitive-impersonal":["estar"]
  }},
  { infinitive: "ir", meaning: "去", category: "不规则动词", note: "完整展示 ir 的常用变位。", forms: {
    ...
    "imperative-affirmative":["—","vai","vá","vamos","ide","vão"], "imperative-negative":["—","não vás","não vá","não vamos","não vades","não vão"], "infinitive-personal":["ir","ires","ir","irmos","irdes","irem"], "infinitive-impersonal":["ir"]
  }},
];
